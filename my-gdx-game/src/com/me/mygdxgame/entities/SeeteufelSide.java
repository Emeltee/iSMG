...
public class SeeteufelSide implements GameEntity, Damageable {
    ...
    private static final int[] SHOT_HEIGHTS = new int[] {60, (int) (60 + MegaPlayer.HITBOX_HEIGHT / 2.5), 60 + MegaPlayer.HITBOX_HEIGHT * 2};
